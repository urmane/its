...
function _M:display()
   ...
   h = h + self.font_h
    ...
    self:makeTexture(("#ffcc80#Gold: %s"):format(player:getGold() or 0), x, h, colors.GOLD.r, colors.GOLD.g, colors.GOLD.b)
    h = h + self.font_h
...
--    h = h + self.font_h
    ...
    self:makeTexture(("Zone: %s"):format(game.zone.name or "none"), x, h, 255, 255, 255)
    h = h + self.font_h

    self:makeTexture(("Area: %s"):format(game.level.data.name or "none"), x, h, 255, 255, 255)
    h = h + self.font_h
