...
return {
	...
	levels = {
		...
		[1] = { width = 64, height = 64, name = "Commodities", generator = { map = { map = "zones/merchant1", }, }, },
		[2] = { width = 64, height = 64, name = "Industrial Products", generator = { map = { map = "zones/merchant2", }, }, },
		[3] = { width = 64, height = 65, name = "Art Galleries", generator = { map = { map = "zones/merchant3", }, }, },
		[4] = { width = 40, height = 40, name = "Financial District", generator = { map = { map = "zones/merchant4", }, }, },
	},
