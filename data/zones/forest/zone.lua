...
return {
	...
	levels = {
		...
		[1] = { width = 64, height = 64, name = "Woods", generator = { map = { map = "zones/forest1", }, }, },
		[2] = { width = 64, height = 64, name = "Clearing", generator = { map = { map = "zones/forest2", }, }, },
		[3] = { width = 64, height = 65, name = "Cave", generator = { map = { map = "zones/forest3", }, }, },
		[4] = { width = 40, height = 40, name = "???", generator = { map = { map = "zones/forest4", }, }, },
	},
