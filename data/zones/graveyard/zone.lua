...
return {
	...
	levels = {
		[1] = { width = 64, height = 64, name = "Potter's Field",       generator = { map = { class = "engine.generator.map.Static", map = "zones/graveyard1", }, }, },
		[2] = { width = 64, height = 64, name = "Commoner's Graveyard", generator = { map = { class = "engine.generator.map.Static", map = "zones/graveyard2", }, }, },
		[3] = { width = 64, height = 64, name = "Haunted Tombs",        generator = { map = { class = "engine.generator.map.Static", map = "zones/graveyard3", }, }, },
		[4] = { width = 64, height = 64, name = "Ancient Mausoleums",   generator = { map = { class = "engine.generator.map.Static", map = "zones/graveyard4", }, }, },
	},
