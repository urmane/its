...
newEntity{
        ...
        notice = true,
        change_level=1, change_zone="market",
}

newEntity{
        define_as = "SEWER_ENTRANCE",
        always_remember = true,
        show_tooltip=true,
        name="A dark, cracked sewer pipe.",
        display='>', color=colors.VIOLET,
        -- image = "terrain/stair_up_wild.png",
        notice = true,
        change_level=3, change_zone="sewers",
}

newEntity{
        define_as = "CHURCH_ENTRANCE",
        always_remember = true,
        show_tooltip=true,
        name="An old church can be seen through the bushes.",
        display='>', color=colors.VIOLET,
        -- image = "terrain/stair_up_wild.png",
        notice = true,
