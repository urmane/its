...
return {
	...
	levels = {
		...
		[1] = { width = 64, height = 64, name = "Holding Cells",   generator = { map = { map = "zones/prison1", }, }, },
		[2] = { width = 64, height = 64, name = "Dungeon",         generator = { map = { map = "zones/prison2", }, }, },
		[3] = { width = 64, height = 65, name = "Torture Chamber", generator = { map = { map = "zones/prison3", }, }, },
		[4] = { width = 40, height = 40, name = "Oubliette",       generator = { map = { map = "zones/prison4", }, }, },
	},

    post_process = function(l)
        if l.level == 4 then
        	-- creepy darkness
        	game.state:makeWeatherShader(l, "weather_vapours", {move_factor=500000, evolve_factor=100000, color={0.8, 0.8, 0.8, 0.2}, zoom=0.5})
	...
	on_enter = function(lev, old_lev, newzone)
        ...
        elseif lev == 3 and not game.state.storyflags["entered-gora-prison3"] then
            ...
            Dialog:simplePopup("Lowest level", "You hear water to the South ... ah, sewers.  That's your way out.")
        --fixme
