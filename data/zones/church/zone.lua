...
return {
	...
	levels = {
		...
		[1] = { width = 64, height = 64, name = "Nave",              generator = { map = { map = "zones/church1", }, }, },
		[2] = { width = 64, height = 64, name = "Sanctuary",         generator = { map = { map = "zones/church2", }, }, },
		[3] = { width = 64, height = 65, name = "Sanctum Sanctorum", generator = { map = { map = "zones/church3", }, }, },
		[4] = { width = 40, height = 40, name = "Catacombs",         generator = { map = { map = "zones/church4", }, }, },
	},
