...
newEntity{
        ...
        always_remember = true,
        show_tooltip=true,
        name="The road to the docks.",
        display='>', color=colors.VIOLET,
        -- image = "terrain/stair_up_wild.png",
        notice = true,
        change_level=1, change_zone="docks",
}
...
newEntity{
        ...
        always_remember = true,
        show_tooltip=true,
        name="The gates to the upper class neighborhoods.",
        display='>', color=colors.VIOLET,
        -- image = "terrain/stair_up_wild.png",
        notice = true,
        change_level=1, change_zone="upper",
}
...
newEntity{
        ...
        always_remember = true,
        show_tooltip=true,
        name="Streets to the Lower Wards.",
        display='>', color=colors.VIOLET,
        -- image = "terrain/stair_up_wild.png",
        notice = true,
        change_level=1, change_zone="lower",
}
