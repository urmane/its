...
return {
	...
	levels = {
		[1] = { all_lited = true, width = 64, height = 64, name = "Market Square", generator = { map = { map = "zones/market1", }, }, },
		[2] = { all_lited = true, width = 64, height = 64, name = "Bazaar",        generator = { map = { map = "zones/market2", }, }, },
		[3] = { all_lited = true, width = 64, height = 64, name = "Artisan's Shops",    generator = { map = { map = "zones/market3", }, }, },
		[4] = { all_lited = true, width = 64, height = 64, name = "Grey Market", generator = { map = { map = "zones/market4", }, }, },
	},
